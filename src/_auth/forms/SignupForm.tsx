...
const SignupForm = () => {
  ...
  // calling the create user account function as a hook
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    // this will create the user in the auth as well as save the user to the DB
    try {
      ...
      // add the session to the user context
